...
CREATE TABLE daily_reports (
  ...
  total_groups NUMERIC(10, 2) DEFAULT 0,
  total_customers NUMERIC(10, 2) DEFAULT 0,
...
CREATE TABLE staff_daily_results (
  ...
  groups NUMERIC(10, 2) DEFAULT 0,
  customers NUMERIC(10, 2) DEFAULT 0,
  base_salary INTEGER DEFAULT 0,
  champagne_deduction INTEGER DEFAULT 0,
  paid_salary INTEGER DEFAULT 0,
  fraction_cut INTEGER DEFAULT 0,
  sales_memo TEXT DEFAULT '',
  salary_memo TEXT DEFAULT '',
  created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
  updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
