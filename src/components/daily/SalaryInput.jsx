...
const SalaryInput = ({ data, onChange, store, salesAmount, calculatedSalary, paidSalary, staffs, selectedStaffId, onStaffChange, onNextStaff, memoValue, onMemoChange, onBlur = () => {} }) => {
